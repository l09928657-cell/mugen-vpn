...
{
    m_process->setArguments(mugen::sanitizeArguments(m_program, arguments));
}
...
{
    m_program = static_cast<mugen::PermittedProcess>(programId);
    m_process->setProgram(mugen::permittedProcessPath(m_program));
