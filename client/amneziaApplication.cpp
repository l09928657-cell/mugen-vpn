...
bool MugenApplication::m_forceQuit = false;

MugenApplication::MugenApplication(int &argc, char *argv[]) : AMNEZIA_BASE_CLASS(argc, argv),
...
MugenApplication::~MugenApplication()
{
...
void MugenApplication::registerTypes()
{
    ...
    mugen::declareQmlProtocolEnum();
    Vpn::declareQmlVpnConnectionStateEnum();
    PageLoader::declareQmlPageEnum();
}

void MugenApplication::loadFonts()
{
...
bool MugenApplication::parseCommands()
{
...
void MugenApplication::startLocalServer() {
    const QString serverName("MugenVPNInstance");
...
bool MugenApplication::eventFilter(QObject *watched, QEvent *event)
{
...
void MugenApplication::forceQuit()
{
    m_forceQuit = true;
    quit();
}

QQmlApplicationEngine *MugenApplication::qmlEngine() const
{
    return m_engine;
}

QNetworkAccessManager *MugenApplication::networkManager()
{
    return m_nam;
}

QClipboard *MugenApplication::getClipboard()
{
