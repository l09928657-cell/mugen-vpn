...
namespace mugen
{
    ...
    namespace protocols
    {
        ...
        namespace dns
        {
            constexpr char mugenDnsIp[] = "172.29.172.254";
        }
        ...
        namespace openvpn
        {
            ...
            constexpr char serverConfigPath[] = "/opt/mugen/openvpn/server.conf";
            constexpr char caCertPath[] = "/opt/mugen/openvpn/pki/ca.crt";
            constexpr char clientCertPath[] = "/opt/mugen/openvpn/pki/issued";
            constexpr char taKeyPath[] = "/opt/mugen/openvpn/ta.key";
            constexpr char clientsDirPath[] = "/opt/mugen/openvpn/clients";
            ...
            constexpr char tlsAuthString[] = "tls-auth /opt/mugen/openvpn/ta.key 0";
        ...
        {
            constexpr char ssKeyPath[] = "/opt/mugen/shadowsocks/shadowsocks.key";
        ...
        namespace xray
        {
            constexpr char serverConfigPath[] = "/opt/mugen/xray/server.json";
            constexpr char uuidPath[] = "/opt/mugen/xray/xray_uuid.key";
            constexpr char PublicKeyPath[] = "/opt/mugen/xray/xray_public.key";
            constexpr char PrivateKeyPath[] = "/opt/mugen/xray/xray_private.key";
            constexpr char shortidPath[] = "/opt/mugen/xray/xray_short_id.key";
        ...
        namespace cloak
        {
            constexpr char ckPublicKeyPath[] = "/opt/mugen/cloak/cloak_public.key";
            constexpr char ckBypassUidKeyPath[] = "/opt/mugen/cloak/cloak_bypass_uid.key";
            constexpr char ckAdminKeyPath[] = "/opt/mugen/cloak/cloak_admin_uid.key";
            constexpr char defaultPort[] = "443";
...
#endif
            constexpr char serverConfigPath[] = "/opt/mugen/wireguard/wg0.conf";
            constexpr char serverPublicKeyPath[] = "/opt/mugen/wireguard/wireguard_server_public_key.key";
            constexpr char serverPskKeyPath[] = "/opt/mugen/wireguard/wireguard_psk.key";
        ...
        namespace awg
        {
            ...
            constexpr char serverConfigPath[] = "/opt/mugen/awg/awg0.conf";
            constexpr char serverLegacyConfigPath[] = "/opt/mugen/awg/wg0.conf";
            constexpr char serverPublicKeyPath[] = "/opt/mugen/awg/wireguard_server_public_key.key";
            constexpr char serverPskKeyPath[] = "/opt/mugen/awg/wireguard_psk.key";
        ...
        namespace telemt
        {
            ...
            constexpr char defaultPort[]           = "443";
            constexpr char defaultTlsDomain[]      = "googletagmanager.com";
            constexpr char defaultUserName[]       = "mugen";
            constexpr char defaultWorkers[]        = "2";
            constexpr char workersModeAuto[]       = "auto";
            constexpr char workersModeManual[]     = "manual";
            constexpr int  maxWorkers              = 32;
