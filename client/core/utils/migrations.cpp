...
void Migrations::migrateV3()
{
    ...
    QString packageName = "org.mugen.vpn";
    ...
    QString location = rootLocation + "/files/.config/MugenVPN.ORG/MugenVPN.conf";
    ...
    if (oldConfig.exists()) {
        ...
        QFile newConfigFile(newConfigPath + "/MugenVPN.conf");
        ...
        if (!newConfigFile.exists()) {
            ...
            if (cpResult) {
                ...
                oldConfigDir.rmdir("MugenVPN.ORG");
            }
        }
    }
#endif
