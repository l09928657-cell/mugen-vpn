...
public slots:
    ...
    void updateModel(mugen::DockerContainer container, const mugen::MtProxyProtocolConfig &protocolConfig);

    void updateModel(const QJsonObject &config);

    QJsonObject getConfig();

    mugen::MtProxyProtocolConfig getProtocolConfig();
...
private:
    ...
    mugen::MtProxyProtocolConfig m_protocolConfig;
};
