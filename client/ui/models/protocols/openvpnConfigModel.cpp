...
bool OpenVpnConfigModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    case Roles::BlockDnsRole: {
        if (!m_protocolConfig.clientConfig.has_value()) {
            m_protocolConfig.clientConfig = mugen::OpenVpnClientConfig{};
        }
...
void OpenVpnConfigModel::updateModel(mugen::DockerContainer container, const mugen::OpenVpnProtocolConfig &protocolConfig)
{
    beginResetModel();
...
void OpenVpnConfigModel::applyDefaultsToServerConfig(mugen::OpenVpnServerConfig& config)
{
...
void OpenVpnConfigModel::applyDefaultsToClientConfig(mugen::OpenVpnClientConfig& config)
{
...
mugen::OpenVpnProtocolConfig OpenVpnConfigModel::getProtocolConfig()
{
