...
struct XrayConfigSnapshot
{
    ...
    QDateTime createdAt;
    mugen::XrayServerConfig serverConfig;
...
public slots:
    ...
    Q_INVOKABLE void createFromCurrent(const mugen::XrayServerConfig &serverConfig);
    Q_INVOKABLE mugen::XrayServerConfig applyConfig(int index) const;
...
private:
    ...
    void persistAll();
    void loadAll();
    static QString buildDisplayName(const mugen::XrayServerConfig &cfg);
};
