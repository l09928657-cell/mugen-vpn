...
void Ikev2ConfigModel::updateModel(mugen::DockerContainer container, const mugen::Ikev2ProtocolConfig &protocolConfig)
{
    beginResetModel();
...
mugen::Ikev2ProtocolConfig Ikev2ConfigModel::getProtocolConfig()
{
