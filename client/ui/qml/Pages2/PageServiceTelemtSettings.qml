        ...
        ListViewType {
            ...
            delegate: ColumnLayout {
                ...
                Rectangle {
                    ...
                    radius: 8
                    border.color: MugenStyle.color.slateGray
                    border.width: 1
                    ...
                    RowLayout {
                        ...
                        CaptionTextType {
                            ...
                            color: secret !== "" ? MugenStyle.color.goldenApricot : MugenStyle.color.mutedGray
        ...
        ListViewType {
            ...
            delegate: ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        CaptionTextType {
                            ...
                            color: secret !== "" ? MugenStyle.color.paleGray : MugenStyle.color.mutedGray
                            wrapMode: Text.WrapAnywhere
                            font.pixelSize: 14
                        }
                    ...
                    listView: Component {
                        ListViewType {
                            ...
                            delegate: LabelWithButtonType {
                                ...
                                rightImageColor: MugenStyle.color.goldenApricot
                                clickedFunction: function () {
                ...
                LabelWithButtonType {
                    ...
                    rightImageColor: MugenStyle.color.mutedGray
                    clickedFunction: function () {
                        expanded = !expanded
                    }
                }
                    ...
                    Repeater {
                        ...
                        delegate: RowLayout {
                            ...
                            ImageButtonType {
                                ...
                                hoverEnabled: true
                                image: "qrc:/images/controls/copy.svg"
                                imageColor: MugenStyle.color.mutedGray
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ImageButtonType {
                            ...
                            implicitHeight: 32
                            image: "qrc:/images/controls/refresh-cw.svg"
                            imageColor: diagLoading ? MugenStyle.color.mutedGray : MugenStyle.color.paleGray
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            height: 8
                            radius: 4
                            color: diagClientsConnected >= 0 ? (diagPortReachable ? MugenStyle.color.paleGray : MugenStyle.color.vibrantRed) : MugenStyle.color.mutedGray
                        }
                        CaptionTextType {
                            Layout.fillWidth: true
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            height: 8
                            radius: 4
                            color: diagClientsConnected >= 0 ? (diagTelegramReachable ? MugenStyle.color.paleGray : MugenStyle.color.vibrantRed) : MugenStyle.color.mutedGray
                        }
                        CaptionTextType {
                            Layout.fillWidth: true
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            height: 8
                            radius: 4
                            color: diagClientsConnected >= 0 ? MugenStyle.color.goldenApricot : MugenStyle.color.mutedGray
                        }
                        CaptionTextType {
                            Layout.fillWidth: true
                    ...
                    LabelWithButtonType {
                        ...
                        rightImageColor: MugenStyle.color.paleGray
                        clickedFunction: function () {
