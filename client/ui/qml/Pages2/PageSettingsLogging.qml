...
PageType {
    ...
    QtObject {
        ...
        readonly property string description: qsTr("MugenVPN logs")
    ...
    QtObject {
        ...
        readonly property string description: qsTr("MugenVPN-service logs")
        ...
        readonly property var exportLogsHandler: function() {
            ...
            fileName = SystemController.getFileName(qsTr("Save"),
                                                    qsTr("Logs files (*.log)"),
                                                    StandardPaths.standardLocations(StandardPaths.DocumentsLocation) + "/MugenVPN-service",
                                                    true,
                                                    ".log")
            if (fileName !== "") {
                PageController.showBusyIndicator(true)
