...
PageType {
    ...
    property string configFileName: "mugen_config"
    ...
    ListView {
                    ...
                    FlickableType {
                        ...
                        ColumnLayout {
                            ...
                            TextArea {
                                ...
                                wrapMode: Text.Wrap
                                background: Rectangle { color: MugenStyle.color.transparent }
                            }
                        }
                    }
                }
        ...
        delegate: ColumnLayout {
            ...
            ParagraphTextType {
                ...
                text: qsTr("To read the QR code in the Mugen app, select \"Add server\" → \"I have data to connect\" → \"QR code, key or settings file\"")
            }
        }
    }
}
