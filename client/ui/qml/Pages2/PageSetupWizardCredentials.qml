    ...
    ListViewType {
        ...
        delegate: ColumnLayout {
            ...
            WarningType {
                ...
                backGroundColor: MugenStyle.color.translucentWhite
        ...
        footer: ColumnLayout {
            ...
            LabelTextType {
                ...
                text: qsTr("All data you enter will remain strictly confidential and will not be shared or disclosed to the Mugen or any third parties")
            }
