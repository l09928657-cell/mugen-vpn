...
PageType {
    ...
    ListViewType {
        ...
        header: ColumnLayout {
            ...
            ParagraphTextType {
                ...
                color: root.isSubscriptionExpired
                    ? MugenStyle.color.vibrantRed
                    : MugenStyle.color.goldenApricot
            }
        ...
        footer: ColumnLayout {
            ...
            readonly property bool isVisibleForMugenFree: ApiAccountInfoModel.data("isComponentVisible")
            ...
            BasicButtonType {
                ...
                leftImageColor: MugenStyle.color.goldenApricot
            ...
            DividerType {
                visible: footer.isVisibleForMugenFree
            }
            ...
            WarningType {
                ...
                backGroundColor: MugenStyle.color.translucentRichBrown
            ...
            LabelWithButtonType {
                Layout.fillWidth: true
                Layout.topMargin: footer.isVisibleForMugenFree ? 0 : 32
