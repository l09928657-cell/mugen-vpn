...
Rectangle {
    ...
    border.color: selected ? MugenStyle.color.goldenApricot : MugenStyle.color.charcoalGray
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            LabelTextType {
                ...
                color: root.selected ? MugenStyle.color.goldenApricot : MugenStyle.color.paleGray
                font.pixelSize: 17
