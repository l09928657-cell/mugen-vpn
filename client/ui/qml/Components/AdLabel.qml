...
Rectangle {
    ...
    gradient: Gradient {
        ...
        GradientStop { position: 0.0; color: MugenStyle.color.translucentSlateGray }
        GradientStop { position: 1.0; color: MugenStyle.color.translucentOnyxBlack }
    }
    border.width: 1
    border.color: MugenStyle.color.onyxBlack
    radius: 13
    ...
    RowLayout {
        ...
        Item {
            ...
            Rectangle {
                ...
                border.color: MugenStyle.color.paleGray
    ...
    MouseArea {
        ...
        onEntered: {
            chevronBackground.color = MugenStyle.color.slateGray
        }

        onExited: {
            chevronBackground.color = MugenStyle.color.transparent
        }

        onPressedChanged: {
            chevronBackground.color = pressed ? MugenStyle.color.charcoalGray : containsMouse ? MugenStyle.color.slateGray : MugenStyle.color.transparent
        }
