...
Rectangle {
    ...
    property string borderHoveredColor: MugenStyle.color.charcoalGray
    property string borderNormalColor: MugenStyle.color.slateGray
    ...
    MouseArea {
        ...
        ColumnLayout {
            ...
            TextArea {
                ...
                placeholderTextColor: MugenStyle.color.mutedGray
