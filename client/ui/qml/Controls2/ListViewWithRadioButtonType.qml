    ...
    delegate: ColumnLayout {
        ...
        RadioButton {
            ...
            indicator: Rectangle {
                ...
                color: radioButton.hovered ? MugenStyle.color.slateGray : MugenStyle.color.onyxBlack
                border.color: radioButton.focus ? MugenStyle.color.paleGray : MugenStyle.color.transparent
