...
TabButton {
    ...
    property string hoveredColor: MugenStyle.color.richBrown
    property string defaultColor: MugenStyle.color.slateGray
    property string selectedColor: MugenStyle.color.goldenApricot
