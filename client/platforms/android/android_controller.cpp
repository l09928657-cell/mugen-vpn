...
namespace
{
    ...
    constexpr auto QT_ANDROID_CONTROLLER_CLASS = "org/mugen/vpn/qt/QtAndroidController";
    constexpr auto ANDROID_LOG_CLASS = "org/mugen/vpn/util/Log";
    constexpr auto TAG = "MugenQt";
} // namespace
